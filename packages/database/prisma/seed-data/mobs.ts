...
export function getAllMobTemplates() {
  return [
    ...
    mob({ id: m.alphaWolf, name: 'Alpha Wolf', zoneId: z.deepForest, level: 8, hp: 65, accuracy: 12, defence: 16, magicDefence: 6, evasion: 6, damageMin: 6, damageMax: 12, xpReward: 55, spellPattern: [spell(3, 'Howl', { buff: true }), spell(5, 'Lunge', { damage: 10 })] }),
    ...
    mob({ id: m.banditCaptain, name: 'Bandit Captain', zoneId: z.deepForest, level: 8, hp: 60, accuracy: 11, defence: 15, magicDefence: 10, evasion: 5, damageMin: 5, damageMax: 11, xpReward: 50, spellPattern: [spell(2, 'Rally', { buff: true }), spell(5, 'Power Strike', { damage: 12 })] }),
    ...
    mob({ id: m.ancientSpirit, name: 'Ancient Spirit', zoneId: z.ancientGrove, level: 16, hp: 70, accuracy: 12, defence: 18, magicDefence: 24, evasion: 10, damageMin: 6, damageMax: 12, xpReward: 65, spellPattern: [spell(2, 'Spirit Shield', { buff: true }), spell(4, 'Soul Drain', { damage: 10 }), spell(7, 'Wrath', { damage: 15 })], damageType: 'magic' }),
    ...
    mob({ id: m.ancientTreant, name: 'Ancient Treant', zoneId: z.ancientGrove, level: 14, hp: 75, accuracy: 9, defence: 26, magicDefence: 13, evasion: 0, damageMin: 5, damageMax: 10, xpReward: 50, spellPattern: [spell(3, 'Root Cage', { damage: 8 }), spell(6, 'Bark Shield', { buff: true })] }),
    ...
    mob({ id: m.pixieSwarm, name: 'Pixie Swarm', zoneId: z.ancientGrove, level: 10, hp: 20, accuracy: 9, defence: 6, magicDefence: 10, evasion: 14, damageMin: 2, damageMax: 5, xpReward: 22, spellPattern: [spell(2, 'Confusion', { debuff: true })], damageType: 'magic' }),
    ...
    mob({ id: m.faeKnight, name: 'Fae Knight', zoneId: z.ancientGrove, level: 14, hp: 50, accuracy: 11, defence: 16, magicDefence: 14, evasion: 8, damageMin: 5, damageMax: 10, xpReward: 46, spellPattern: [spell(2, 'Enchanted Blade', { buff: true }), spell(5, 'Fae Strike', { damage: 11 })] }),
    mob({ id: m.faeQueen, name: 'Fae Queen', zoneId: z.ancientGrove, level: 17, hp: 75, accuracy: 13, defence: 20, magicDefence: 26, evasion: 12, damageMin: 6, damageMax: 13, xpReward: 75, spellPattern: [spell(2, 'Royal Guard', { buff: true }), spell(4, 'Charm', { debuff: true }), spell(6, 'Fae Wrath', { damage: 16 })], damageType: 'magic' }),
    ...
    mob({ id: m.giantCaveSpider, name: 'Giant Cave Spider', zoneId: z.caveEntrance, level: 5, hp: 30, accuracy: 7, defence: 8, magicDefence: 3, evasion: 5, damageMin: 3, damageMax: 7, xpReward: 26, spellPattern: [spell(3, 'Web Trap', { debuff: true })] }),
    ...
    mob({ id: m.batSwarmLord, name: 'Bat Swarm Lord', zoneId: z.caveEntrance, level: 8, hp: 55, accuracy: 11, defence: 10, magicDefence: 4, evasion: 6, damageMin: 4, damageMax: 9, xpReward: 48, spellPattern: [spell(2, 'Screech', { debuff: true }), spell(5, 'Swarm', { damage: 10 })] }),
    ...
    mob({ id: m.goblinShaman, name: 'Goblin Shaman', zoneId: z.caveEntrance, level: 8, hp: 45, accuracy: 7, defence: 8, magicDefence: 12, evasion: 5, damageMin: 3, damageMax: 6, xpReward: 44, spellPattern: [spell(2, 'Hex', { debuff: true }), spell(4, 'Fire Bolt', { damage: 8 }), spell(6, 'Dark Ritual', { damage: 12 })], damageType: 'magic' }),
    ...
    mob({ id: m.goblinForeman, name: 'Goblin Foreman', zoneId: z.deepMines, level: 13, hp: 45, accuracy: 10, defence: 14, magicDefence: 7, evasion: 3, damageMin: 5, damageMax: 10, xpReward: 42, spellPattern: [spell(4, 'Whip Crack', { buff: true })] }),
    mob({ id: m.goblinChieftain, name: 'Goblin Chieftain', zoneId: z.deepMines, level: 16, hp: 70, accuracy: 12, defence: 18, magicDefence: 10, evasion: 4, damageMin: 6, damageMax: 12, xpReward: 60, spellPattern: [spell(2, 'War Cry', { buff: true }), spell(4, 'Cleave', { damage: 10 }), spell(7, 'Execute', { damage: 15 })] }),
    ...
    mob({ id: m.crystalGolemMob, name: 'Crystal Golem', zoneId: z.deepMines, level: 17, hp: 100, accuracy: 11, defence: 32, magicDefence: 12, evasion: 0, damageMin: 7, damageMax: 14, xpReward: 70, spellPattern: [spell(3, 'Crystal Barrage', { damage: 8 }), spell(5, 'Harden', { buff: true }), spell(8, 'Shatter', { damage: 16 })] }),
    ...
    mob({ id: m.burrower, name: 'Burrower', zoneId: z.deepMines, level: 13, hp: 50, accuracy: 11, defence: 16, magicDefence: 6, evasion: 4, damageMin: 5, damageMax: 10, xpReward: 44, spellPattern: [spell(3, 'Burrow', { buff: true }), spell(5, 'Ambush', { damage: 11 })] }),
    ...
    mob({ id: m.packAlpha, name: 'Pack Alpha', zoneId: z.whisperingPlains, level: 16, hp: 80, accuracy: 14, defence: 20, magicDefence: 8, evasion: 6, damageMin: 7, damageMax: 13, xpReward: 65, spellPattern: [spell(2, 'Howl', { buff: true }), spell(4, 'Savage Bite', { damage: 12 }), spell(7, 'Frenzy', { damage: 16 })] }),
    ...
    mob({ id: m.banditLieutenant, name: 'Bandit Lieutenant', zoneId: z.whisperingPlains, level: 13, hp: 50, accuracy: 11, defence: 14, magicDefence: 8, evasion: 5, damageMin: 5, damageMax: 10, xpReward: 44, spellPattern: [spell(3, 'Dirty Trick', { debuff: true })] }),
    mob({ id: m.banditWarlord, name: 'Bandit Warlord', zoneId: z.whisperingPlains, level: 16, hp: 75, accuracy: 13, defence: 18, magicDefence: 10, evasion: 5, damageMin: 6, damageMax: 12, xpReward: 62, spellPattern: [spell(2, 'Battle Cry', { buff: true }), spell(4, 'Shield Bash', { damage: 8 }), spell(6, 'Devastating Blow', { damage: 14 })] }),
    ...
    mob({ id: m.harpyMatriarch, name: 'Harpy Matriarch', zoneId: z.whisperingPlains, level: 16, hp: 70, accuracy: 13, defence: 16, magicDefence: 18, evasion: 8, damageMin: 6, damageMax: 12, xpReward: 64, spellPattern: [spell(2, 'Screech', { debuff: true }), spell(4, 'Talon Fury', { damage: 10 }), spell(7, 'Tempest', { damage: 16 })], damageType: 'magic' }),
    ...
    mob({ id: m.wraith, name: 'Wraith', zoneId: z.hauntedMarsh, level: 22, hp: 60, accuracy: 13, defence: 14, magicDefence: 20, evasion: 10, damageMin: 6, damageMax: 12, xpReward: 56, spellPattern: [spell(3, 'Life Drain', { damage: 8, heal: 8 }), spell(5, 'Fear', { debuff: true })], damageType: 'magic' }),
    mob({ id: m.deathKnight, name: 'Death Knight', zoneId: z.hauntedMarsh, level: 26, hp: 100, accuracy: 15, defence: 24, magicDefence: 14, evasion: 4, damageMin: 8, damageMax: 16, xpReward: 85, spellPattern: [spell(2, 'Dark Aura', { buff: true }), spell(4, 'Soul Strike', { damage: 12 }), spell(7, 'Death Blow', { damage: 20 })] }),
    ...
    mob({ id: m.ancientCrocodile, name: 'Ancient Crocodile', zoneId: z.hauntedMarsh, level: 27, hp: 110, accuracy: 14, defence: 26, magicDefence: 8, evasion: 1, damageMin: 8, damageMax: 16, xpReward: 82, spellPattern: [spell(3, 'Death Roll', { damage: 12 }), spell(5, 'Submerge', { buff: true }), spell(7, 'Jaws', { damage: 18 })] }),
    mob({ id: m.hagServant, name: 'Hag Servant', zoneId: z.hauntedMarsh, level: 18, hp: 35, accuracy: 10, defence: 10, magicDefence: 14, evasion: 6, damageMin: 4, damageMax: 8, xpReward: 32, spellPattern: [spell(3, 'Curse', { debuff: true })], damageType: 'magic' }),
    ...
    mob({ id: m.bogWitch, name: 'Bog Witch', zoneId: z.hauntedMarsh, level: 23, hp: 55, accuracy: 12, defence: 12, magicDefence: 18, evasion: 8, damageMin: 5, damageMax: 11, xpReward: 54, spellPattern: [spell(2, 'Hex', { debuff: true }), spell(4, 'Shadow Bolt', { damage: 9 }), spell(6, 'Drain Life', { damage: 7, heal: 7 })], damageType: 'magic' }),
    mob({ id: m.covenMother, name: 'Coven Mother', zoneId: z.hauntedMarsh, level: 27, hp: 85, accuracy: 14, defence: 18, magicDefence: 24, evasion: 7, damageMin: 7, damageMax: 14, xpReward: 80, spellPattern: [spell(2, 'Dark Shield', { buff: true }), spell(4, 'Poison Cloud', { damage: 10 }), spell(6, 'Curse of Weakness', { debuff: true }), spell(8, 'Cataclysm', { damage: 18 })], damageType: 'magic' }),
    ...
    mob({ id: m.goblinArtificer, name: 'Goblin Artificer', zoneId: z.crystalCaverns, level: 23, hp: 60, accuracy: 13, defence: 16, magicDefence: 10, evasion: 5, damageMin: 6, damageMax: 11, xpReward: 56, spellPattern: [spell(3, 'Bomb Trap', { damage: 9 }), spell(5, 'Gadget Shield', { buff: true })] }),
    mob({ id: m.goblinKingMob, name: 'Goblin King', zoneId: z.crystalCaverns, level: 27, hp: 95, accuracy: 15, defence: 22, magicDefence: 14, evasion: 5, damageMin: 7, damageMax: 15, xpReward: 82, spellPattern: [spell(2, 'Royal Decree', { buff: true }), spell(4, 'Golden Strike', { damage: 12 }), spell(6, 'Gem Barrage', { damage: 14 }), spell(8, "Crown's Fury", { damage: 20 })] }),
    ...
    mob({ id: m.diamondGolemMob, name: 'Diamond Golem', zoneId: z.crystalCaverns, level: 24, hp: 90, accuracy: 11, defence: 32, magicDefence: 12, evasion: 0, damageMin: 7, damageMax: 13, xpReward: 60, spellPattern: [spell(4, 'Crystal Slam', { damage: 11 }), spell(6, 'Diamond Shell', { buff: true })] }),
    mob({ id: m.golemOverlord, name: 'Golem Overlord', zoneId: z.crystalCaverns, level: 28, hp: 130, accuracy: 13, defence: 36, magicDefence: 14, evasion: 0, damageMin: 8, damageMax: 16, xpReward: 90, spellPattern: [spell(3, 'Shockwave', { damage: 10 }), spell(5, 'Crystal Prison', { debuff: true }), spell(7, 'Overload', { damage: 16 }), spell(9, 'Collapse', { damage: 22 })] }),
    ...
    mob({ id: m.stormCrystalMob, name: 'Storm Crystal', zoneId: z.crystalCaverns, level: 23, hp: 55, accuracy: 14, defence: 18, magicDefence: 22, evasion: 7, damageMin: 6, damageMax: 12, xpReward: 58, spellPattern: [spell(3, 'Lightning Arc', { damage: 9 }), spell(5, 'Static Field', { debuff: true })], damageType: 'magic' }),
    mob({ id: m.crystalTitan, name: 'Crystal Titan', zoneId: z.crystalCaverns, level: 27, hp: 90, accuracy: 16, defence: 24, magicDefence: 28, evasion: 5, damageMin: 8, damageMax: 16, xpReward: 85, spellPattern: [spell(2, 'Resonance', { buff: true }), spell(4, 'Crystal Storm', { damage: 12 }), spell(6, 'Prism Beam', { damage: 16 }), spell(8, 'Shatter All', { damage: 22 })], damageType: 'magic' }),
    ...
    mob({ id: m.spectralCaptain, name: 'Spectral Captain', zoneId: z.sunkenRuins, level: 32, hp: 80, accuracy: 16, defence: 20, magicDefence: 24, evasion: 8, damageMin: 8, damageMax: 14, xpReward: 72, spellPattern: [spell(3, 'Ghost Blade', { damage: 10 }), spell(5, 'Spectral Chains', { debuff: true })], damageType: 'magic' }),
    mob({ id: m.lich, name: 'Lich', zoneId: z.sunkenRuins, level: 36, hp: 120, accuracy: 18, defence: 26, magicDefence: 34, evasion: 6, damageMin: 9, damageMax: 18, xpReward: 110, spellPattern: [spell(2, 'Death Ward', { buff: true }), spell(4, 'Necrotic Bolt', { damage: 14 }), spell(6, 'Raise Dead', { buff: true }), spell(8, 'Soul Harvest', { damage: 22 })], damageType: 'magic' }),
    ...
    mob({ id: m.nagaWarrior, name: 'Naga Warrior', zoneId: z.sunkenRuins, level: 32, hp: 70, accuracy: 17, defence: 22, magicDefence: 16, evasion: 8, damageMin: 7, damageMax: 14, xpReward: 74, spellPattern: [spell(3, 'Trident Thrust', { damage: 11 }), spell(5, 'Scale Shield', { buff: true })] }),
    mob({ id: m.nagaQueenMob, name: 'Naga Queen', zoneId: z.sunkenRuins, level: 36, hp: 110, accuracy: 19, defence: 28, magicDefence: 22, evasion: 7, damageMin: 9, damageMax: 18, xpReward: 105, spellPattern: [spell(2, 'Tidal Blessing', { buff: true }), spell(4, 'Water Jet', { damage: 14 }), spell(6, 'Constrict', { debuff: true }), spell(8, 'Tsunami', { damage: 24 })], damageType: 'magic' }),
    ...
    mob({ id: m.tentacleHorror, name: 'Tentacle Horror', zoneId: z.sunkenRuins, level: 29, hp: 50, accuracy: 13, defence: 16, magicDefence: 10, evasion: 4, damageMin: 6, damageMax: 11, xpReward: 50, spellPattern: [spell(3, 'Grapple', { debuff: true })] }),
    ...
    mob({ id: m.eldritchAbomination, name: 'Eldritch Abomination', zoneId: z.sunkenRuins, level: 36, hp: 140, accuracy: 17, defence: 28, magicDefence: 32, evasion: 3, damageMin: 10, damageMax: 20, xpReward: 120, spellPattern: [spell(2, 'Madness Aura', { debuff: true }), spell(4, 'Void Bolt', { damage: 14 }), spell(6, 'Tentacle Storm', { damage: 18 }), spell(9, 'Consume', { damage: 28 })], damageType: 'magic' }),
  ];
}
