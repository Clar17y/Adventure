...
async function seedZones() {
  ...
  const zones: Prisma.ZoneCreateManyInput[] = [
    { id: IDS.zones.millbrook, name: 'Millbrook', description: 'A peaceful town nestled at the forest edge. Crafters and merchants ply their trade here.', difficulty: 0, travelCost: 0, isStarter: true, zoneType: 'town' },
    { id: IDS.zones.forestEdge, name: 'Forest Edge', description: 'A bright woodland border with gentle paths. Creatures stir among the undergrowth.', difficulty: 1, travelCost: 50, isStarter: false, zoneType: 'wild' },
    { id: IDS.zones.deepForest, name: 'Deep Forest', description: 'Dense and shadowed. Predators stalk between the ancient trees.', difficulty: 2, travelCost: 150, isStarter: false, zoneType: 'wild' },
    { id: IDS.zones.caveEntrance, name: 'Cave Entrance', description: 'A yawning cavern mouth. Strange sounds echo from within.', difficulty: 2, travelCost: 150, isStarter: false, zoneType: 'wild' },
    { id: IDS.zones.ancientGrove, name: 'Ancient Grove', description: 'A sacred woodland where spirits dwell among towering trees.', difficulty: 3, travelCost: 300, isStarter: false, zoneType: 'wild' },
    { id: IDS.zones.deepMines, name: 'Deep Mines', description: 'Abandoned mine shafts descending into darkness. Something lurks below.', difficulty: 3, travelCost: 300, isStarter: false, zoneType: 'wild' },
    { id: IDS.zones.whisperingPlains, name: 'Whispering Plains', description: 'Vast grasslands where the wind carries distant cries.', difficulty: 3, travelCost: 250, isStarter: false, zoneType: 'wild' },
    { id: IDS.zones.thornwall, name: 'Thornwall', description: 'A fortified frontier settlement. Advanced crafting facilities line the main road.', difficulty: 0, travelCost: 0, isStarter: false, zoneType: 'town' },
    { id: IDS.zones.hauntedMarsh, name: 'Haunted Marsh', description: 'Fetid swampland shrouded in mist. The dead do not rest here.', difficulty: 4, travelCost: 400, isStarter: false, zoneType: 'wild' },
    { id: IDS.zones.crystalCaverns, name: 'Crystal Caverns', description: 'Glittering underground chambers pulsing with arcane energy.', difficulty: 4, travelCost: 400, isStarter: false, zoneType: 'wild' },
    { id: IDS.zones.sunkenRuins, name: 'Sunken Ruins', description: 'Ancient ruins half-submerged in brackish water. Unspeakable things dwell in the depths.', difficulty: 5, travelCost: 600, isStarter: false, zoneType: 'wild' },
  ];
