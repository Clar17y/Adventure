...
const MOB_PREFIX_DEFINITIONS: readonly MobPrefixDefinition[] = [
  {
    ...
    weight: 15,
    statMultipliers: { hp: 0.6, accuracy: 0.8, defence: 0.7, magicDefence: 0.7, damageMin: 0.7, damageMax: 0.7 },
    xpMultiplier: 0.6,
  ...
  },
  {
    ...
    weight: 8,
    statMultipliers: { hp: 0.8, defence: 0.5, magicDefence: 0.5, evasion: 0.5 },
    xpMultiplier: 0.9,
  ...
  },
  {
    ...
    weight: 8,
    statMultipliers: { hp: 1.5, defence: 1.3, magicDefence: 1.3, damageMin: 1.1, damageMax: 1.1 },
    xpMultiplier: 1.3,
  ...
  },
  {
    ...
    weight: 4,
    statMultipliers: { hp: 2, defence: 1.2, magicDefence: 1.2, evasion: 0.5, damageMin: 1.3, damageMax: 1.3 },
    xpMultiplier: 1.6,
  ...
  },
  {
    ...
    weight: 6,
    statMultipliers: { hp: 0.8, defence: 0.8, magicDefence: 0.8, evasion: 2, damageMin: 0.95, damageMax: 0.95 },
    xpMultiplier: 1.2,
    dropChanceMultiplier: 1,
    spellTemplate: null,
  },
  {
    ...
    weight: 5,
    statMultipliers: { hp: 1.2, accuracy: 1.4, defence: 0.9, magicDefence: 0.9, damageMin: 1.4, damageMax: 1.4 },
    xpMultiplier: 1.4,
    dropChanceMultiplier: 1.2,
    spellTemplate: null,
  },
  ...
  },
  {
    ...
    weight: 1,
    statMultipliers: { hp: 1.5, accuracy: 1.3, defence: 1.3, magicDefence: 1.3, evasion: 1.3, damageMin: 1.3, damageMax: 1.3 },
    xpMultiplier: 2,
  ...
  },
  {
    ...
    weight: 2,
    statMultipliers: { hp: 0.7, defence: 0.5, magicDefence: 1.5, evasion: 3, damageMin: 0.6, damageMax: 0.6 },
    xpMultiplier: 1.7,
