...
const MOB_PREFIX_DEFINITIONS: readonly MobPrefixDefinition[] = [
  {
    ...
    weight: 15,
    statMultipliers: { hp: 0.6, accuracy: 0.8, defence: 0.7, damageMin: 0.7, damageMax: 0.7 },
    xpMultiplier: 0.6,
  ...
  },
  {
    ...
    weight: 5,
    statMultipliers: { hp: 1.2, accuracy: 1.4, defence: 0.9, damageMin: 1.4, damageMax: 1.4 },
    xpMultiplier: 1.4,
    dropChanceMultiplier: 1.2,
    spellTemplate: null,
  },
  {
    ...
    weight: 3,
    statMultipliers: { accuracy: 0.8, defence: 0.8, damageMin: 0.8, damageMax: 0.8 },
    xpMultiplier: 1.5,
    dropChanceMultiplier: 1.3,
    spellTemplate: {
      startRound: 3,
  ...
  },
  {
    ...
    weight: 1,
    statMultipliers: { hp: 1.5, accuracy: 1.3, defence: 1.3, evasion: 1.3, damageMin: 1.3, damageMax: 1.3 },
    xpMultiplier: 2,
